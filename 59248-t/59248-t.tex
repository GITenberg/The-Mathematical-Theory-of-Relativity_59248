% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
%                                                                         %
% The Project Gutenberg EBook of The Mathematical Theory of Relativity, by 
...
%% multicol: Two-column layout for index; required.                 %%
%% textcase: Lowercase only text in running heads; required.        %%
%%                                                                  %%
...
%%                                                                  %%
%%                                                                  %%
%% PDF pages: 448 (if ForPrinting set to false)                     %%
%% PDF page size: 5.2 x 6.9" (non-standard)                         %%
%%                                                                  %%
%% Summary of log file:                                             %%
%% * Seven overfull hboxes, two underfull hboxes, all acceptable.   %%
%%                                                                  %%
%% Compile History:                                                 %%
%%                                                                  %%
%% April, 2019: (Andrew D. Hwang)                                   %%
%%     texlive2016, GNU/Linux                                       %%
%%                                                                  %%
%% Command block:                                                   %%
%%                                                                  %%
%%     pdflatex x4                                                  %%
...
%%   pdflatex 59248-t.tex ..... FOUR times                          %%
%%   makeindex 59248-t.idx                                          %%
%%   pdflatex 59248-t.tex ..... TWO times                           %%
%%                                                                  %%
...
% 1:1.6
  ...
  \setlength{\paperwidth}{5.2in}%
  \setlength{\paperheight}{6.9in}%
  \raggedbottom
% 3:4
...
\usepackage[pdftex,
  ...
  pdftitle={The Project Gutenberg eBook \#\ebook: The Mathematical Theory of Relativity},
...
\AtBeginDocument{\renewcommand{\contentsname}%
  {\protect\thispagestyle{empty}%
    \protect\ChapHead{\textbf{Contents}}\protect\vspace{-\baselineskip}}
}
...
\begin{center}
  ...
  LONDON : FETTER LANE, E.C. 4 \\[1in]
  %[** Cambridge University Press publisher's device]
  LONDON : H. K. LEWIS AND CO., \textsc{Ltd.}, \\
  {\scriptsize 136 Gower Street, W.C. 1} \\
...
\scriptsize PLUMIAN PROFESSOR OF ASTRONOMY AND EXPERIMENTAL \\[6pt]
...
\begin{center}
  \null\vfill
  \scriptsize PRINTED IN GREAT BRITAIN
\end{center}
\newpage
\PageSep{v}
...
\First{A FIRST} draft of this book was published in 1921 as a mathematical supplement
...
to the following points in the notation. The summation convention (\PageRef{50})
is used. German letters always denote the product of the corresponding
English letter by~$\sqrt{-g}$ (\PageRef{111}). $\Ham$~is the symbol for ``Hamiltonian differentiation''
introduced on \PageRef{139}. An asterisk is prefixed to symbols generalised
so as to be independent of or covariant with the gauge (\PageRef{203}).
\PageSep{vi}
...
\First{The} subject of this mathematical treatise is not pure mathematics but
...
physics. Force had become ``$\text{mass} × \text{acceleration}$,'' and was no longer an invisible
...
It has been explained in the early chapters of \Title{Space, Time and Gravitation}
...
theory was patched up although its original \Foreign{raison d'être} had vanished. Obsessed
...
\begin{align*}
  ...
  &= g_{\alpha\beta}\, \frac{\dd^{2} x_{\alpha}}{\dd x_{\mu}'\, \dd x_{\nu}'}
  · g'^{\lambda\rho}\, \frac{\dd x_{\beta}}{\dd x_{\lambda}'}\, \frac{\dd x_{\epsilon}}{\dd x_{\rho}'} \\
...
\begin{align*}
  ...
  &= \frac{\dd A^{\mu}}{\dd x_{\mu}}
  + A^{\epsilon} · \frac{1}{\sqrt{-g}}\, \frac{\dd}{\dd x_{\epsilon}} \sqrt{-g}
  \quad\text{by~\Eq{(35.4)}} \\
...
We shall now prove the fundamental theorem of mechanics---
...
\begin{align*}
  &= \tfrac{1}{2} \{\mu\alpha, \beta\}\, \delta\left(\sqrt{-g} · g^{\mu\nu} g^{\alpha\epsilon}
  ...
  &= -\tfrac{1}{2} \{\mu\alpha, \beta\}\, \delta\left(\sqrt{-g} · \frac{\dd g^{\mu\alpha}}{\dd x_{\beta}}\right)
...
volume''
\[
\iiiint \Chg{\surd\bigl\{-|\Star{G}_{\mu\nu}|\bigr\}}{\sqrt{-|\Star{G}_{\mu\nu}|}}\, d\tau,
\]
...
the ordering of events in nature not expressible in terms of a \Chg{fourfold}{four-fold} coordinate-system.
...
$\frac{1}{4} F^{\mu\nu} F_{\mu\nu} · \sqrt{-g}\, d\tau$, we now suppose that it is more exactly the Hamiltonian
derivative of $\Chg{\surd(-|\Star{G}_{\mu\nu}|)}{\sqrt{-|\Star{G}_{\mu\nu}|}}\, d\tau$ with respect to~$\kappa_{\mu}$\footnotemark.\footnotetext
...
Then
\[
\delta(\Chg{\surd\Delta}{\sqrt{\Delta}})
= \frac{1}{\Chg{\surd\Delta}{\sqrt{\Delta}}}\, \lambda^{2} \left\{
...
\index{Permeability, magnetic}%
\[
\mu = \frac{1}{\Kappa} = \frac{\Chg{\surd\Delta}{\sqrt{\Delta}}}{\lambda^{2}},
\Tag{(101.41)}
\]
so that
\[
\alpha = \lambda^{2}a/\Chg{\surd\Delta}{\sqrt{\Delta}},\quad
P = \lambda^{2}X/\Chg{\surd\Delta}{\sqrt{\Delta}},
\]
and let
\[
S' = S/\Chg{\surd\Delta}{\sqrt{\Delta}}
...
\left.
\begin{gathered}
  \frac{\dd\gamma}{\dd y} - \frac{\dd\beta}{\dd z} = \frac{\dd P}{\dd t} + \sigma'\Add{,} \\
  \frac{\dd P}{\dd x} + \frac{\dd Q}{\dd y} + \frac{\dd R}{\dd z} = \rho'\Add{,}
\end{gathered}
\right\}
\Tag{(101.5)}
\]
...
\begin{gathered}
  \sigma_{x}' = \sigma_{x}
  + \frac{\dd(aS')}{\dd t} + \frac{\dd(ZS')}{\dd y} - \frac{\dd(YS')}{\dd z}\Add{,} \\
...
\begin{gathered}
  \sigma_{x}' = \sigma_{x}
  + a\, \frac{\dd S'}{\dd t} + Z\, \frac{\dd S'}{\dd y} - Y\, \frac{\dd S'}{\dd z}\Add{,} \\
...
Since $\Chg{\surd(\mu\Kappa)}{\sqrt{\mu\Kappa}}$ is always unity, the velocity of propagation is unaltered; and no
...
$1.1 · 10^{-21}$~gm. We transform this into gravitational units by remembering
that the sun's mass, $1.99 · 10^{33}$~gm., is equivalent to $1.47 · 10^{5}$~cm. Hence we
find---

%[**TN: Block indent in the original]
The gravitational mass-density~$T_{4}^{4}$ of an electric field of $1500$~volts
per~cm.\ is $8.4 · 10^{-50}$~cm.\ per~c.c.

According to the equation $E^{\mu\nu} = 8\pi\lambda T^{\mu\nu}$ we shall have
\[
E_{4}^{4} = 2.1 · 10^{-98} \text{ cm.}^{-4}.
\]
...
measure by the number $2 · 10^{-49}$ referred to a Galilean coordinate-system with
a centimetre mesh.
...
discrepancy is
\begin{align*}
  \delta l &= 10^{2} · 2 · 10^{-49} · 10^{3} · 10^{18} \text{ cm.} \\
  &= 2 · 10^{-26} \text{ cm.}
\end{align*}
...
than that of light, \Title{Proc.\ Amsterdam\Typo{.}{}\ Acad.}, 6, p.~809 (1904).
...
\Bibitem{\Typo{H.}{D.} Hilbert.} Die Grundlagen der Physik, \Title{Göttingen Nachrichten}, 1915, p.~395; 1917,
p.~53. \SecRef{61}.
...
\printindex
%[** TN: Prints the following text]
% Index
% The numbers refer to pages

\iffalse
Absolute change 69
  physical quantities@physical quantities|indexfn 5
  properties of a region 205
  rotation 99

Abstract geometry and natural geometry 37

Acceleration of light-pulse 91
  of charged particle#charged 189
  determined by symmetrical condition#symmetrical 192

Action, material or gravitational#Action 137
  electromagnetic 187
  Weyl's formula 209, 231
  numerical values of 237

Action, principle of Stationary#Action 139, 147
...
Angle between two vectors#Angle 58

Antisymmetrical tensors#Antisymmetrical 67
  of fourth rank#Antisymmetrical 107

Aspect, relation of#Aspect 49

Associated tensors 56

Atom, time of vibration of#vibration 91
  in de Sitter's world#Sitter 157, 164

Atomicity@Atomicity|indexfn 120

Atomicity 139, 146

B@$B_{\mu\nu\sigma}^{\epsilon}$ (Riemann-Christoffel tensor)#Riemann-Christoffel 72, 226
...
Charge, electric, conservation of#Charge 173
  invariance of#Charge 174

Charge-and-current vector 172
  general existence of#Charge-and 230

Christoffel's $3$-index symbols#Christoffel 58
  generalisation of#Christoffel 203

Clocks, transport of#Clock 15, 27

Comparability of proximate relations 225

Components, covariant and contravariant#Components 57
...
Conservation, formal law of#Conservation 134

Conservation
  of momentum and mass#Conservation 30
  of energy#Conservation 32
  of matter#Conservation 33
  of electric charge#Conservation 173

Constitutive equations 34, 195

Continuity, equation of#Continuity 117
  in electric flow#Continuity 173

Continuous matter, gravitation in 101, 119

Contracted derivative (divergence)#Divergence 113
  second derivative ($\Wave$) 64

Contraction, FitzGerald#FitzGerald 25

Contraction of tensors 53

Contravariant vectors#Contravariant 43, 44
  tensors#Contravariant 52
  derivatives 62
...
Coordinates 9
  general transformation of#transformation 34, 43
  representation of displacement#Coordinates 49
  difficulty in the introduction of#Coordinates 225

Covariant derivative of vector#Covariant 60
  of tensor#Covariant 62, 65
  of invariant 63
  utility of 63
  significance of 68
...
Creation of the physical world#Creation 147, 230, 238

Curl 67

Current, electric#Current 172

Curvature
  Gaussian 82
  of 4-dimensional manifold#Curvature 149
  radius of spherical 151
  quadric of 152
...
Deductive theory and experiment#Deductive 105

Deflection of light 90

Density
  Lorentz transformation of 33
  definitions of proper- 121

Density
  scalar-and tensor- 111
  in-invariant- 205
...
Determinants, manipulation of#Determinant 107

Differentiation
  covariant, rules for 65

Differentiation: |seealso{Derivative}

Differentiation of summed expression 75

Dimensions, principle of 48, 54

Dimensions, world of $3 + 1$#Dimensions 25
  reason for four#Dimensions 206
...
Displacement of spectral lines to red, in sun#spectral 91
  in nebulae#nebulae 157, 161

Distance. |See{Length}

Divergence
  tensor@of a tensor 113
  energy@of energy-tensor 115, 119
  Hamiltonian@of Hamiltonian derivative of an invariant 141
...
E@$E_{\mu\nu}$ (electromagnetic energy-tensor)#electromagnetic 181
...
Einstein's law of gravitation 81
  in continuous matter 101, 119
  interpretation of 154
  alternatives to 143
  equivalent to the gauging-equation 221
...
Electromagnetic action 187
  ...
  signals 28
  volume 194
  waves, propagation of 175

Electron
  non-Maxwellian stresses in 183
  gravitational field of 185
  acceleration in electromagnetic field 189
  size of 192
  magnetic constitution of 211
...
Energy-tensor of matter 116, 141
  electromagnetic@of electromagnetic field 182
  obtained by Hamiltonian differentiation 147, 229
...
F@$F_{\mu\nu}$ (electromagnetic force)#electromagnetic 171, 219
...
Flux 67
  gravitational 144
  electromagnetic 192, 232

Force, covariant and contravariant components 50
  expressed by $3$-index symbols#expressed 122

Force
  electromagnetic 171
  Lorentz transformation of 179
  mechanical force due to 180, 189, 229
...
Geodesic, equations of 60
  produced by parallel displacement 71

Geodesic curvature 91

Geometry, Riemannian 11
  abstract and natural 37
  world geometry 198
  affine geometry 214
...
Gravitation |seealso{Einstein's law}
...
Gravitational mass of sun 87
  equality with inertial mass 130, 145

Group 47

H@$\Ham$ (Hamiltonian operator)#Hamiltonian 139

ham@$h_{\mu}$ (ponderomotive force)#ponderomotive 181

Hamiltonian derivative 139
  of fundamental invariants 141
  of electromagnetic action 187
  of general world-invariants 228
  creative aspect of 147, 230, 238
...
Inertia
  elementary treatment 29
  electromagnetic origin of 183

Inertial frame, precession of 99

Inertial mass 128
  equal to gravitational mass 130, 145
...
J@$J^{\mu}$ (charge-and-current vector)#charge-and 172
...
Length
  definition of 1, 217
  measurement of 11
  non-integrability of 198

Length of a vector 57

Light
  velocity of 19, 23
  deflection in gravitational field 90
  propagation of 175

Light-pulse
  equation of track 37
  in curved world 163
  in-invariant equation 220
...
Lorentz transformation 17, 25
  for electromagnetic force 179

M@$M_{\mu\nu}$ (material energy-tensor)#material 181
...
Mass
  invariant and relative 30, 183
  gravitational and inertial 128, 130, 145
  electromagnetic 193

Mass
  variation with velocity 30
  identified with energy 32
  of electromagnetic field 183
...
Matter
  conservation of 33
  identification of 119, 146

Maxwell's equations 172
  second order corrections to 234
...
Metric
  introduction of 216
  sole character of space and time 221
...
Normal, $6$-dimensional#Normal 151
...
Potential
  gravitational 59, 124
  electromagnetic 171, 175, 201
...
Pressure
  hydrostatic 121
  in homogeneous sphere 169

Principle
  of dimensions 48, 54
  of equivalence 41
  of identification 119, 222
  of least action 139, 147, 209
  of measurement 220, 238

Problem
  of two bodies 95
  of rotating disc 112
  of homogeneous sphere 168

Product, inner and outer 53

Propagation
  of gravitational waves 130
  of electromagnetic waves 175

Propagation with unit velocity 64
  solution of equation 178

Proper-(prefix) 34

Proper-@Proper-|See{Invariant mass \emph{and} Density}
...
Quantum
  excluded from coordinate calculations 225
  numerical value of 237

Quotient law 54

R@$R_{\mu\nu}$ (gauging-tensor)#gauging 219
...
Sitter@de Sitter's spherical world 155, 161
...
Stress-system 117
  gravitational field due to 104
  electromagnetic 183
  non-Maxwellian 184
...
Surface-element 66
  in-invariant pertaining to 232

Symmetry
  a relative attribute 155
  of a particle 125, 155
  of an electron 192

T@$T_{\mu\nu}$ (energy-tensor)#energy 102, 116
...
Time
  definition of 14
  convention in reckoning 15, 29
  immediate consciousness of 23
  extended meaning 39
...
Vector 43
  mathematical notion of 44
  physical notion of 47

Velocity, fundamental 19

Velocity of light 19
  in moving matter 21
  in sun's gravitational field 93

Velocity-vector 71

Volume
  physical and geometrical 110
  electromagnetic 194
  generalised 206, 232
...
%[** TN: Text below printed by end of index]
% CAMBRIDGE : PRINTED BY
% J. B. PEACE, M.A.,
% AT THE UNIVERSITY PRESS
...
\PGLicense
\begin{PGtext}
End of the Project Gutenberg EBook of The Mathematical Theory of Relativity, by 
Arthur Stanley Eddington

*** END OF THIS PROJECT GUTENBERG EBOOK MATHEMATICAL THEORY OF RELATIVITY ***

***** This file should be named 59248-t.tex or 59248-t.zip *****
This and all associated files of various formats will be found in:
        http://www.gutenberg.org/5/9/2/4/59248/
...
my $cline = 0;
 ...
 print "done\\n";';
###
This is pdfTeX, Version 3.1415926-2.5-1.40.14 (TeX Live 2013/Debian) (format=pdflatex 2018.10.12)  10 APR 2019 19:48
...
\c@SecNo=\count127
\@indexfile=\write3
\openout3 = `59248-t.idx'.

Writing index file 59248-t.idx
(./59248-t.aux)
\openout1 = `59248-t.aux'.

LaTeX Font Info:    Checking defaults for OML/cmm/m/it on input line 634.
LaTeX Font Info:    ... okay on input line 634.
LaTeX Font Info:    Checking defaults for T1/cmr/m/n on input line 634.
LaTeX Font Info:    ... okay on input line 634.
LaTeX Font Info:    Checking defaults for OT1/cmr/m/n on input line 634.
LaTeX Font Info:    ... okay on input line 634.
LaTeX Font Info:    Checking defaults for OMS/cmsy/m/n on input line 634.
LaTeX Font Info:    ... okay on input line 634.
LaTeX Font Info:    Checking defaults for OMX/cmex/m/n on input line 634.
LaTeX Font Info:    ... okay on input line 634.
LaTeX Font Info:    Checking defaults for U/cmr/m/n on input line 634.
LaTeX Font Info:    ... okay on input line 634.
LaTeX Font Info:    Checking defaults for PD1/pdf/m/n on input line 634.
LaTeX Font Info:    ... okay on input line 634.
...
* h-part:(L,W,R)=(7.22688pt, 361.34999pt, 7.2269pt)
* v-part:(T,H,B)=(1.26749pt, 495.49379pt, 1.90128pt)
* \paperwidth=375.80377pt
* \paperheight=498.66255pt
* \textwidth=361.34999pt
* \textheight=433.62pt
* \oddsidemargin=-65.0431pt
* \evensidemargin=-65.04309pt
* \topmargin=-71.0025pt
* \headheight=12.0pt
* \headsep=19.8738pt
* \topskip=12.0pt
...
Package hyperref Info: Link coloring ON on input line 634.
...
LaTeX Info: Redefining \ref on input line 634.
LaTeX Info: Redefining \pageref on input line 634.
LaTeX Info: Redefining \nameref on input line 634.
(./59248-t.out) (./59248-t.out)
\@outlinefile=\write4
\openout4 = `59248-t.out'.

LaTeX Font Info:    Try loading font information for U+msa on input line 663.
(/usr/share/texlive/texmf-dist/tex/latex/amsfonts/umsa.fd
File: umsa.fd 2013/01/14 v3.01 AMS symbols A
)
LaTeX Font Info:    Try loading font information for U+msb on input line 663.
...
LaTeX Font Info:    Try loading font information for U+euf on input line 800.
(/usr/share/texlive/texmf-dist/tex/latex/amsfonts/ueuf.fd
File: ueuf.fd 2013/01/14 v3.01 Euler Fraktur
)
LaTeX Font Info:    Try loading font information for OMS+cmr on input line 816.

(/usr/share/texlive/texmf-dist/tex/latex/base/omscmr.fd
File: omscmr.fd 1999/05/25 v2.5h Standard LaTeX font definitions
)
LaTeX Font Info:    Font shape `OMS/cmr/m/n' in size <12> not available
(Font)              Font shape `OMS/cmsy/m/n' tried instead on input line 816.
[6] [7] (./59248-t.toc [8


] [9] [10] [11] [12])
\tf@toc=\write5
\openout5 = `59248-t.toc'.
...
(Font)              Font shape `OMS/cmsy/m/n' tried instead on input line 1298.

LaTeX Font Info:    Font shape `OMS/cmr/m/n' in size <7> not available
(Font)              Font shape `OMS/cmsy/m/n' tried instead on input line 1299.

[6] [7] [8]
LaTeX Font Info:    Font shape `OMS/cmr/m/n' in size <10> not available
(Font)              Font shape `OMS/cmsy/m/n' tried instead on input line 1368.
...
Underfull \hbox (badness 1325) in paragraph at lines 3057--3060
[]\OT1/cmr/m/n/12 Remembering that all ob-ser-va-tional dif-fer-ences of co-ord
-inate-
 []

[57] [58] [59] [60] [61] [62] [63] [64] [65] [66] [67] [68] [69

] [70] [71] [72] [73] [74] [75] [76] [77] [78] [79] [80] [81] [82] [83] [84] [8
5] [86]
Overfull \hbox (0.25462pt too wide) in paragraph at lines 4095--4098
\OT1/cmr/m/n/12 where the na-ture of $\OML/cmm/m/it/12 A\OT1/cmr/m/n/12 (\OML/c
mm/m/it/12 ^^V^^W\OT1/cmr/m/n/12 )$ is not known ini-tially, we see that $\OML/
cmm/m/it/12 A\OT1/cmr/m/n/12 (\OML/cmm/m/it/12 ^^V^^W\OT1/cmr/m/n/12 )$ must
 []
...
LaTeX Font Warning: Command \footnotesize invalid in math mode on input line 65
29.

[151] [152] [153] [154] [155] [156] [157] [158] [159] [160] [161] [162] [163] [
164] [165] [166] [167] [168] [169] [170] [171] [172] [173] [174] [175] [176] [1
77] [178] [179] [180] [181

] [182] [183] [184] [185] [186] [187] [188] [189] [190] [191] [192] [193] [194]
[195] [196]
Overfull \hbox (3.29153pt too wide) in paragraph at lines 8350--8350
[] 
 []

[197] [198] [199] [200] [201] [202] [203] [204] [205] [206] [207] [208] [209] [
210] [211] [212] [213] [214] [215] [216] [217] [218] [219] [220] [221] [222] [2
23] [224] [225] [226] [227] [228] [229] [230] [231] [232] [233] [234] [235] [23
6] [237]
Overfull \hbox (0.30554pt too wide) in paragraph at lines 9965--9965
[] 
 []

[238] [239] [240]
Overfull \hbox (4.20816pt too wide) in paragraph at lines 10114--10114
[] 
 []
...
LaTeX Font Warning: Command \footnotesize invalid in math mode on input line 11
293.


Overfull \hbox (1.31721pt too wide) detected at line 11322
[]
 []
...
316] [317] [318] [319] [320] [321] [322] [323] [324] [325] [326] [327] [328] [3
29] [330] [331] [332

] [333]
Overfull \hbox (3.02997pt too wide) in paragraph at lines 13571--13589
[]\OT1/cmr/m/n/12 In \OT1/cmr/m/it/12 Space, Time and Grav-i-ta-tion\OT1/cmr/m/
n/12 , Chap-ter \OT1/cmr/m/sc/12 xi\OT1/cmr/m/n/12 , Weyl's non-Riemannian
 []

[334] [335] [336]
Overfull \hbox (0.99832pt too wide) in paragraph at lines 13674--13677
[]\OT1/cmr/m/n/12 To ob-tain Weyl's ge-om-e-try we must im-pose two re-stric-ti
ons on $\OML/cmm/m/it/12 F[]$\OT1/cmr/m/n/12 : 
 []

[337] [338] [339] [340] [341] [342] [343] [344] [345] [346] [347] [348] [349] [
350] [351] [352] [353] [354] [355] [356] [357] [358] [359] [360] [361] [362] [3
63] [364] [365] [366] [367] [368] [369] [370] [371] [372] [373] [374] [375] [37
6] [377] [378] [379] [380] [381] [382] [383] [384] [385] [386] [387] [388] [389
] [390] [391] [392] [393] [394] [395] [396] [397] [398] [399] [400] [401] [402]
[403] [404] [405] [406] [407] [408

] [409] [410]
Underfull \hbox (badness 1178) in paragraph at lines 16478--16480
[] []\OT1/cmr/m/n/12 Uber das Grav-i-ta-tions-feld einer Kugel aus in-com-press
-ibler
 []

[411] (./59248-t.ind [412] [413
...
Package atveryend Info: Empty hook `BeforeClearDocument' on input line 17714.
[9]
Package atveryend Info: Empty hook `AfterLastShipout' on input line 17714.
(./59248-t.aux)
Package atveryend Info: Executing hook `AtVeryEndDocument' on input line 17714.
...
Package atveryend Info: Executing hook `AtEndAfterFileList' on input line 17714
.
Package rerunfilecheck Info: File `59248-t.out' has not changed.
(rerunfilecheck)             Checksum: 6A6B12571B165178B0575279D7807735;1067.
Package atveryend Info: Empty hook `AtVeryVeryEnd' on input line 17714.
 ) 
Here is how much of TeX's memory you used:
 10345 strings out of 493304
 134353 string characters out of 6139870
 287330 words of memory out of 5000000
 11537 multiletter control sequences out of 15000+600000
 20267 words of font info for 77 fonts, out of 8000000 for 9000
 957 hyphenation exceptions out of 8191
 31i,19n,45p,292b,943s stack positions out of 5000i,500n,10000p,200000b,80000s
...
ist/fonts/type1/public/amsfonts/cm/cmmi6.pfb></usr/share/texlive/texmf-dist/fon
ts/type1/public/amsfonts/cm/cmmi7.pfb></usr/share/texlive/texmf-dist/fonts/type
1/public/amsfonts/cm/cmmi8.pfb></usr/share/texlive/texmf-dist/fonts/type1/publi
...
cmr17.pfb></usr/share/texlive/texmf-dist/fonts/type1/public/amsfonts/cm/cmr6.pf
...
ic/amsfonts/cm/cmti12.pfb></usr/share/texlive/texmf-dist/fonts/type1/public/ams
fonts/cm/cmtt10.pfb></usr/share/texlive/texmf-dist/fonts/type1/public/amsfonts/
cm/cmtt8.pfb></usr/share/texlive/texmf-dist/fonts/type1/public/amsfonts/euler/e
ufm10.pfb></usr/share/texlive/texmf-dist/fonts/type1/public/amsfonts/symbols/ms
am10.pfb>
Output written on 59248-t.pdf (448 pages, 1406488 bytes).
PDF statistics:
 6173 PDF objects out of 6186 (max. 8388607)
 5402 compressed objects within 55 object streams
 2152 named destinations out of 2487 (max. 500000)
